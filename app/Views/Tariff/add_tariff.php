        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function(index, item) {
                    ...
                    var routeRatesPkm = item.route_rates ? item.route_rates : (item.route_default_rate_pkm ? item.route_default_rate_pkm : '');
                    if(routeRatesPkm !== ''){
                        routeRatesPkm = parseFloat(routeRatesPkm).toFixed(0); 
                    }
